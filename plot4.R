...
# plot1
par(mfrow=c(2,2))
plot(power_sub$Time, power_sub$Global_active_power, type="l", xlab="", ylab="Global Active Power")

# plot2
plot(power_sub$Time, power_sub$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", col=c("black", "red", "blue"), c("Sub_metering_1   ", "Sub_metering_2   ", "Sub_metering_3   "), bty="n", cex=.25, lty=c(1,1), lwd=c(1,1))

# plot4
plot(power_sub$Time, power_sub$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
